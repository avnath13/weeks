...
export const HABIT_PRESETS: HabitPreset[] = [
  ...
  },
  {
    ...
    emoji: "🎵",
    defaultHours: 1.5,
    colorVar: "--event-violet",
    sourceNote: "Active-user average ≈ 1.5h/day",
  },
  {
    id: "meetings",
    label: "Meetings",
  ...
  },
  {
    ...
    emoji: "📺",
    defaultHours: 2,
    colorVar: "--event-amber",
    sourceNote: "Avg. TV/streaming ≈ 2h/day",
  },
  {
    id: "gaming",
    label: "Gaming",
    emoji: "🎮",
    defaultHours: 1,
    colorVar: "--event-emerald",
    sourceNote: "Gamer average ≈ 1h/day",
  },
];
